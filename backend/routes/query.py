...
class QueryRequest(BaseModel):
    ...
    force_documents: Optional[bool] = Field(default=False, description="Force using documents even for general questions")
...
async def query(request: QueryRequest):
    ...
    try:
        result = await query_pipeline.query(
            ...
            top_k=request.top_k,
            force_documents=request.force_documents
        )
...
async def stream_query(
    ...
    force_documents: bool = Query(default=False, description="Force using documents")
):
    """
    ...
    async def event_generator():
        ...
        try:
            async for event in query_pipeline.stream_query(question, top_k, force_documents):
                yield event
        except Exception as e:
